...
import { useCreateProjectModalStore } from "@/features/projects/hooks/use-create-project-modal";
    ...
    <div className="flex flex-col gap-y-4 col-span-1">
      <div className="bg-muted rounded-lg p-4">
        <div className="flex items-center justify-between">
          ...
          <Button variant="muted" size="icon" onClick={() => setOpen(true)}>
...
export const ProjectList = ({ data, total }: ProjectListProps) => {
  const { setOpen } = useCreateProjectModalStore();
  const workspaceId = useWorkspaceId();
              ...
              <Card className="shadow-none rounded-lg overflow-hidden">
                <CardContent className="p-3 flex-col flex items-center gap-x-2">
                  ...
                  <div className="flex flex-col items-center overflow-hidden">
                    <p className="text-xs truncate font-medium line-clamp-1">
                      {member.name}
                    </p>
